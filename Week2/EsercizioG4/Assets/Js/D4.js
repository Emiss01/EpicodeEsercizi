...
switch(starWarsCharacters[i].eye_color) {
  ...
  case 'blue' : eye_color.blue.push(starWarsCharacters[i].name);
  break
  case 'yellow' : eye_color.yellow.push(starWarsCharacters[i].name);
  break
  case 'brown' : eye_color.brown.push(starWarsCharacters[i].name);
  break
  case 'red' : eye_color.red.push(starWarsCharacters[i].name);
  break
  case 'blue_gray' : eye_color.blue_gray.push(starWarsCharacters[i].name);
  break // break sempre utilizzato
}
 };
console.log(eye_color);
/* ESERCIZIO 6
